...
```{figure} assets/exposure-time-calculator-01.png
...
```{figure} assets/exposure-time-calculator-02.png
:alt: NGPS manual figure
:width: 90%
...
The SNR calculation can be very sensitive to these parameters, particularly Seeing (for narrow slits) and Sky (for faint targets). It is important to update them accurately for current conditions.

```{figure} assets/exposure-time-calculator-03.png
:alt: NGPS manual figure
:width: 90%
...
```{figure} assets/exposure-time-calculator-04.png
:alt: NGPS manual figure
:width: 90%
