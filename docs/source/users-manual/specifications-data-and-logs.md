...
```{figure} assets/specifications-data-and-logs-01.png
:alt: NGPS manual figure
:width: 90%
```

```{figure} assets/specifications-data-and-logs-02.png
:alt: NGPS manual figure
:width: 90%
```
...
A log file is recorded which serves as an "observer's notebook" log. This log records key parameters, observations, events and user comments (entered via the GUI). This is stored at `<future_feature>`.
