 ...
 *
 * $Id: AbstractCatalogDirectory.java,v 1.3 2009/04/14 10:56:02 abrighto Exp $
 */
...
public abstract class AbstractCatalogDirectory implements CatalogDirectory, Serializable {
    ...
    // A list of Catalog objects, one for each catalog in the catalog directory
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        catDir._catalogs = new ArrayList<Catalog>(_catalogs);
        return catDir;
    }
    ...
    public Catalog findCatalog(String catalogName) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (cat instanceof CatalogDirectory) {
                cat = ((CatalogDirectory)cat).findCatalog(catalogName);
                if (cat != null) {
                    return cat;
                }
            }
    ...
    public TableQueryResult getCatalogList() {
        ...
        Vector<Vector<Object>> rows = new Vector<Vector<Object>>(numCatalogs, 1);
        for (int i = 0; i < numCatalogs; i++) {
            Vector<Object> cols = new Vector<Object>(1, 1);
    ...
    public boolean isLocal() {
        return _url != null && _url.getProtocol().equals("file");
    }
