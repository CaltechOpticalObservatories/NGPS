 ...
 * ESO Archive
 *
 * $Id: FieldDescAdapter.java,v 1.4 2009/03/05 23:04:25 abrighto Exp $
 *
 * who             when        what
 * --------------  ----------  ----------------------------------------
...
public class FieldDescAdapter implements FieldDesc, Serializable {
    ...
    // True if this field contains the main (or only) world coordinates RA value
    private Boolean _raMainFlag = null; // default to _raFlag

    // True if this field contains the main (or only) world coordinates Dec value
    private Boolean _decMainFlag = null; // default to _decFlag
    ...
    public String getDisplayName() {
        return _displayName != null ? _displayName : getName();
    }
     ...
     */
    public URLQueryResult getLinkValue(TableQueryResult tableQueryResult, Object value, int row)
     ...
     */
    public boolean isRA() {
        return _raFlag || (_raMainFlag != null ? _raMainFlag : false);
    }
    ...
    public boolean isDec() {
        return _decFlag || (_decMainFlag != null ? _decMainFlag : false);
    }
    ...
    /**
     * @return true if this field contains the main (or only) world coordinates Dec value.
     * If not set, defaults to isDec().
     */
    public boolean isDecMain() {
        return _decMainFlag != null ? _decMainFlag : _decFlag;
    }

    /**
     * Set to true if this field contains the main (or only) world coordinates RA value.
     */
    ...
    /**
     * @return true if this field contains the main (or only) world coordinates RA value.
     * If not set, defaults to isRA().
     */
    public boolean isRaMain() {
        return _raMainFlag != null ? _raMainFlag : _raFlag;
    }
