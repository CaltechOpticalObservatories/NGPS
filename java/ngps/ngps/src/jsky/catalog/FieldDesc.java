 ...
 * ESO Archive
 *
 * $Id: FieldDesc.java,v 1.4 2009/03/05 23:04:25 abrighto Exp $
 *
 * who             when        what
 * --------------  ----------  ----------------------------------------
...
public abstract interface FieldDesc {
    ...
    /** Return the name to display (defaults to name) */
    ...
    /**
     * Returns the UCD (VO's Unified Content Descriptor) if known, otherwise null
     */
