/*
 * $Id: TablePlotSymbol.java,v 1.4 2009/04/21 13:31:17 abrighto Exp $
 */
...
public class TablePlotSymbol extends DVMap {
    ...
    /**
     * Parse the plot symbol information in Tcl list format and return
     ...
     *
     * @param symbolInfo plot symbol description
    ...
    public Object getObjectProperty(String name) {
        ...
        for (int i = 0; i < _colNames.length; i++) {
            if (_colNames[i].equals(name)) {
                return _rowVec.get(_colIndexes[i]);
            }
        }
        return null;
    }
