 ...
 * ESO Archive
 *
 * $Id: WorldCoords.java,v 1.2 2009/02/20 23:10:11 abrighto Exp $
 *
 * who             when        what
 * --------------  ----------  ----------------------------------------
...
//                cospa = 1.0;
            if (Math.abs(cospa) > 1.0)
                cospa=cospa/Math.abs(cospa); // 2005-06-02: fix from awicenec@eso.org
     ...
     * @param pos2 The second endpoint of the box.
     *
