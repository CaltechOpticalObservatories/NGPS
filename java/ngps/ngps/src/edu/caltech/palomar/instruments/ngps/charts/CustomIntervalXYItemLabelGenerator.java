 ...
 */
public class CustomIntervalXYItemLabelGenerator extends AbstractXYItemLabelGenerator implements XYItemLabelGenerator, Cloneable, PublicCloneable,
                   Serializable {
     ...
     */
    public CustomIntervalXYItemLabelGenerator() {
     ...
     *                 not permitted).
     */
    public CustomIntervalXYItemLabelGenerator(String formatString,
    ...
    public String generateLabelString(XYDataset dataset, int series, int item) {
        ...
        result = (java.lang.String)items[0];
        return result;
    }
    /**
