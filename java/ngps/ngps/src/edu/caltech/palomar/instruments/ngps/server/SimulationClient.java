...
public class SimulationClient {
  ...
  public SimulationClient(){
      ...
      boolean status = true;
      if(status){
          sendCommand("SET STATE EXPOSING");
      }
  }  
  ...
  public void sendCommand(java.lang.String command){
     ...
     myClientSocket.sendReceiveCommand(command, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimulationClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
