...
//
//	See the NED home page, http://ned.ipac.caltech.edu/, for more information
//	about NED.
//
//--- Development History -----------------------------------------------------
//
...
package edu.caltech.palomar.util.ned;
...
/**
 * NedReader provides the ability to search the <A HREF="http://ned.ipac.caltech.edu/">NED</A>
...
public class NedReader
{
	...
	**/
	 ...
	 * @exception	ForbiddenTargetException	thrown if unable to enable the Netscape security privilege
	**/
	...
	**/
			...
			throws NumberFormatException
	{
		...
		for (Enumeration enum1 = moreTable.keys(); enum1.hasMoreElements();)
		{
	...
	**/
	public static void main(String[] args)
	{
		...
		{
			System.out.println("OBJECT: " + ((NedObject) enum1.nextElement()).getName());
		}
