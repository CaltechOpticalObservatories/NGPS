...
public class CrosshairDemo1 extends ApplicationFrame {
    ...
    private static class MyDemoPanel extends DemoPanel
        ...
        public MyDemoPanel() {
            ...
            this.model.setValueAt(0.0, 0, 1);
            this.model.setValueAt(0.0, 0, 2);
            this.model.setValueAt(0.0, 0, 3);
            this.model.setValueAt(0.0, 0, 4);
            this.model.setValueAt(0.0, 0, 5);
            this.model.setValueAt(0.0, 0, 6);
