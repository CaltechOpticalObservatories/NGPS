...
public class CrossSectionDemo1 extends ApplicationFrame {
    ...
    static class MyDemoPanel extends DemoPanel implements ChangeListener,
        ...
        public MyDemoPanel() {
            ...
            slider1Panel.add(this.slider1, BorderLayout.WEST);
        ...
        public void stateChanged(ChangeEvent e) {
            if (e.getSource() == this.slider1) {
                ...
                XYDataset d = HeatMapUtils.extractColumnFromHeatMapDataset(
                ...
                XYDataset d = HeatMapUtils.extractRowFromHeatMapDataset(
        ...
        private JFreeChart createChart(XYDataset dataset) {
            ...
            BufferedImage image = HeatMapUtils.createHeatMapImage(this.dataset,
                    ps);
