...
public class CombinedXYPlotDemo3 extends ApplicationFrame {
    ...
    private static JFreeChart createCombinedChart() {
        ...
        // add subplot 3...
        XYPlot subplot3 = new XYPlot(dataset2, new DateAxis("Date 3"), null, 
                new XYBarRenderer(0.20));
        parent.add(subplot3, 1);

        // now make the top level JFreeChart
        chart = new JFreeChart("Demo Chart", JFreeChart.DEFAULT_TITLE_FONT, 
                parent, true);
    ...
    public static void main(String[] args) {
        ...
        CombinedXYPlotDemo3 demo = new CombinedXYPlotDemo3(
