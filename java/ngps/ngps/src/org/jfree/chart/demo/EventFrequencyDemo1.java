...
public class EventFrequencyDemo1 extends ApplicationFrame {
    ...
    private static CategoryDataset createDataset() {
        ...
        dataset.setValue(d1.getMiddleMillisecond(), "Series 1", "Requirement 1");
        dataset.setValue(d1.getMiddleMillisecond(), "Series 1", "Requirement 2");
        dataset.setValue(d2.getMiddleMillisecond(), "Series 1", "Requirement 3");
        dataset.setValue(d3.getMiddleMillisecond(), "Series 2", "Requirement 1");
        dataset.setValue(d4.getMiddleMillisecond(), "Series 2", "Requirement 3");
        dataset.setValue(d5.getMiddleMillisecond(), "Series 3", "Requirement 2");
        dataset.setValue(d6.getMiddleMillisecond(), "Series 1", "Requirement 4");
