...
public class NormalDistributionDemo2 extends ApplicationFrame {
    ...
    public static XYDataset createDataset() {
        ...
        XYSeries s1 = DatasetUtils.sampleFunction2DToSeries(n1, -5.1, 5.1,
                121, "N1");
        dataset.addSeries(s1);

        Function2D n2 = new NormalDistributionFunction2D(0.0, Math.sqrt(0.2));
        XYSeries s2 = DatasetUtils.sampleFunction2DToSeries(n2, -5.1, 5.1,
                121, "N2");
        dataset.addSeries(s2);

        Function2D n3 = new NormalDistributionFunction2D(0.0, Math.sqrt(5.0));
        XYSeries s3 = DatasetUtils.sampleFunction2DToSeries(n3, -5.1, 5.1,
                121, "N3");
        dataset.addSeries(s3);

        Function2D n4 = new NormalDistributionFunction2D(-2.0, Math.sqrt(0.5));
        XYSeries s4 = DatasetUtils.sampleFunction2DToSeries(n4, -5.1, 5.1,
                121, "N4");
    ...
    public static void main(String[] args) {
        NormalDistributionDemo2 demo = new NormalDistributionDemo2(
