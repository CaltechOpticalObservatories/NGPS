/* --------------------------------
 * SlidingCategoryDatasetDemo1.java
 * --------------------------------
...
public class SlidingCategoryDatasetDemo1 extends ApplicationFrame {
    ...
    static class MyDemoPanel extends DemoPanel implements ChangeListener {
        ...
        public MyDemoPanel() {
            ...
            this.scroller = new JScrollBar(SwingConstants.VERTICAL, 0, 20, 0,
                    50);
            add(cp1);
    ...
    public static void main(String[] args) {
        SlidingCategoryDatasetDemo1 demo = new SlidingCategoryDatasetDemo1(
