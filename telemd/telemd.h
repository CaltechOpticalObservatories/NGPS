/** ---------------------------------------------------------------------------
 * @file     telemd.h
 * @brief    telemetry daemon include file
 * @details  defines the classes used by the telemetry daemon
...
Telemetry::Server telemd;         ///< global Telemetry::Server object so that the main daemon can access the server namespace
